...
### Atari vs. Amiga </br>
were very similar, but with different Key changes. </br>
...
Falcon & TT are The Best & Last machines produced by Atari. </br>
...
ATW800/2 is a recreation board in FPGA, giving HDMI output + 1x Transputer CPU to a TT 030 machine using VMEbus. </br>
